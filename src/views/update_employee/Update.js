            ...
            <div class="leftbox">
                {/* <nav>
                    ...
                    <a onclick="tabs(1)" class="tab">
                        <img src={clipboard_icon} />
                    </a>
                </nav> */}
            </div>
            <div class="rightbox">
                <div class="profile tabShow">
                    <h1>ACTUALIZAR INFORMACIÓN DEL VENDEDOR</h1>
                    <h2>Nombre completo</h2>
                    <input id="nombre" type="text" class="input" placeholder="Nombre"></input>
                    <h2>Fecha de nacimiento</h2>
                    <input id="fecha_nacimiento" type="date" class="input" placeholder=""></input>
                    <h2>Email</h2>
                    <input id="email" type="email" class="input" placeholder="Email"></input>
                    <h2>Contraseña Actual</h2>
                    <input id="current_password" type="password" class="input" placeholder="*******"></input>
                    <h2>Nueva Contraseña</h2>
                    <input id="new_password_1" type="password" class="input" placeholder="*******"></input>
                    <h2>Repetir Contraseña</h2>
                    <input id="new_password_2" type="password" class="input" placeholder="*******"></input>
                    <button onClick={updateInfo} class="btn">Actualizar</button>
                </div>
            </div>
        </div>
    );
